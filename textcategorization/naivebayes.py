...
class NaiveBayesClassifier():
    """
        Implementation of Naive Bayes   . Used to classify the articles without a topic label
        ...
        KNN code inspired from https://scikit-learn.org/stable/modules/naive_bayes.html
    """
    ...
    def process(self):
        ...
        with open('updated_corpus_reuters_nb.json', 'w') as outfile:
            json.dump(self.training_set + updated_articles,
                      outfile, ensure_ascii=False, indent=4)

        with open('set_of_updated_reuters_articles_nb.json', 'w') as outfile:
